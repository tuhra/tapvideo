		...
		<div class="content-wrap">
			...
			<div class="content">
				...
				<div class="welcome"> 
					<center>
					<br>
				 	<span style="height: 7px;width: 7px;background-color: #00FF00;border-radius: 50%;display: inline-block;"></span><span style="color: #fff;font-size: 12px;"> သင်သည်ဝန်ဆောင်မှုကိုရယူထားပြီးဖြစ်ပါသည်</span>
                    <br><br>
					<span class="service-btn"><b> ဖုန်းနံပါတ် - {{ $msisdn }}  </b></span>
					<br><br>
                   	<b>နှစ်သက်သောဗွီဒီယို - {!! fav_vdo_count() !!} ခု </b>
                   	<br><br>
                   	<a href="{{ url('/favourite') }}"><button type="button" class="btn unscribe_btn"><h5 style="color: white;font-weight: bold;">ကြည့်ရန်</h5></button></a>
				 </center>
				</div>
